"""
Inception-V1 inflated 3D 

The code was adapted from https://github.com/dlpbc/keras-kinetics-i3d/blob/master/i3d_inception.py 
...
def Inception_Inflated3d(include_top=True,
    ...
    x = tf.keras.layers.AveragePooling3D((2, 1, 1), 
                                              strides=(1, 1, 1),
                                              padding='valid')(x)
